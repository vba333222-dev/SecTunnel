...
class _ProfileFormScreenState extends State<ProfileFormScreen>
  ...
  void _populateFromProfile(BrowserProfile p) {
    ...
    _keepAliveEnabled = p.keepAliveEnabled;
...
class _AdvancedTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _tabScroll(children: [
      ...
      // ── Keep-Alive ──────────────────────────
      _sectionHeader('Keep-Alive', icon: Icons.bolt, tooltip: 'Runs a Headless WebView in an Android Foreground Service so your session stays active (WebSocket/Mining) when app is minimized.'),
      _SettingsToggleCard(
        title: 'Enable Keep-Alive Farm',
        subtitle: 'Maintains active session in background',
        value: keepAliveEnabled,
        onChanged: onKeepAliveToggled,
