...
class CanvasSpoof {
  static String generate(FingerprintConfig config) {
    // Combine profile-specific salt with the global session seed.
    // This ensures variations are unique per profile but change slightly
    // across different app sessions, preventing static rendering detection.
